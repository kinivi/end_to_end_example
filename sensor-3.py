...
class Device(object):
    ...
    def __init__(self):
        self.pressure = 0
        self.attributes = {"id": "sensor-3", "location": [40.80555, 50.10730], "time": datetime.datetime.utcnow()}
        self.fan_on = False
    ...
    def update_sensor_data(self):
        ...
        """
        if self.fan_on:
            self.pressure = random.randint(400, 1000)
        else:
            self.pressure = random.randint(400, 1000)
...
def main():
    ...
    for _ in range(args.num_messages):
        ...
        # as a JSON string.
        payload = json.dumps({'pressure': device.pressure, 'attributes': device.attributes})
